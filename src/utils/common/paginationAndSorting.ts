 ...
 * Если в query что-то есть, то в зависимости от коллекции создаем массив с ключами соответствующего типа
 ...
 * Если ничего не совпадет, то вернем sortBy с значением по умолчанию 'createdAt'
