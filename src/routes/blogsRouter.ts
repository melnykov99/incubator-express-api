...
blogsRouter.put('/', (req: RequestWithParamsAndBody<GetDeleteBlogById, CreateUpdateBlog>, res: Response) => {
...
blogsRouter.delete('/', (req: RequestWithParams<GetDeleteBlogById>, res: Response) => {
